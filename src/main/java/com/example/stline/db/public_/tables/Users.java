...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = -1260978143;
     ...
     */
    public final TableField<UsersRecord, Integer> ROLE = createField("role", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<UsersRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UsersRecord, ?>>asList(Keys.USERS__FK_USERS_ROLES);
    }

    public Roles roles() {
        return new Roles(this, Keys.USERS__FK_USERS_ROLES);
    }
