...
public class Photos extends TableImpl<PhotosRecord> {
    ...
    private static final long serialVersionUID = -616360300;
     ...
     */
    public final TableField<PhotosRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('photos_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<PhotosRecord, Long> PRODUCT = createField("product", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    @Override
    public Identity<PhotosRecord, Long> getIdentity() {
        return Keys.IDENTITY_PHOTOS;
    }
